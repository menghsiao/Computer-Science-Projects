...
class Node
{
    ...
    public boolean insertNode(Node node)
    {
        ...
        if(node.getKey() != this.getKey()) {
            ...
            System.out.println("Duplicate key integer value, not inserted");
            return false;
        }
...
class BinaryTree
{
    ...
    public boolean deleteNode(int key)
    {
        ...
        if (succ == null){
            ...
            else {  // succ has a left child
                Node parentRightMost = succ;
                Node rightMost = succ.getLeft();  // to the left subtree of succ
                
                while(rightMost.getRight() != null) {
                    parentRightMost = rightMost;
                    rightMost = rightMost.getRight();
                }
                parent.replaceChild(node, rightMost);
                
                // delete rightMost node
                if(parentRightMost.getRight() == rightMost)
                    parentRightMost.setRight(rightMost.getLeft());
                else
                    parentRightMost.setLeft(rightMost.getLeft());
